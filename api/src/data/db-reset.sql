...
('test_clerk_id1', 'Mozartstrasse', '4-10', '53115', 'Bonn', 'Germany'),
('test_clerk_id2', 'Mozartstrasse', '4-10', '53115', 'Bonn', 'Germany'),
('test_clerk_id3', 'Mozartstrasse', '4-10', '53115', 'Bonn', 'Germany');

INSERT INTO boxes (user_id, location) VALUES -- enter longitude before latitude
('test_clerk_id1', ST_GeographyFromText('SRID=4326;POINT(7.090183 50.732843)')),
('test_clerk_id2', ST_GeographyFromText('SRID=4326;POINT(7.090315 50.733017)')),
('test_clerk_id3', ST_GeographyFromText('SRID=4326;POINT(7.090492 50.732749)'));
